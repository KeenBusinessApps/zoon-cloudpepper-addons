        ...
        if account_type == 'Zoon+':
            ...
            if sub_product:
                partner = request.env['res.partner'].sudo().create({
                    'name': full_name,
                    'x_studio_first_name': name,
                    'x_studio_last_name': last_name,
                    'x_studio_customer_email': email,
                    'mobile': mobile,
                    'phone': mobile,
                    'street': street1,
                    'street2': street2,
                ...
                if not sub_product:
                    return json.dumps({'status': 'error', 'message': 'There is no Product available for Subscription.'})
