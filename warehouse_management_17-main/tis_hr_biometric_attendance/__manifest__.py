...

{
    ...
    'summary': 'Seamless integration of ZKteco biometric devices with Odoo for accurate employee attendance tracking.',
 ...
 New feature: Support for passing the card number  during synchronization.
 """,
